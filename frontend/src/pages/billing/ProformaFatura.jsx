  ...
  const invoices = [
    {
      ...
      issuerAddress:
        "YAYLA MAH. YOZGAT BUL. No:208 Kapı No:20 K.ÖRENİ Ankara / Türkiye",
  ...
  return (
    ...
    >
      <TableComp2
        ...
        tableTitle={"PROFORMA FATURA LİSTESİ"}
        modal={"proforma-invoice-modal"}
      />
    </motion.div>
  );
};

export default ProformaFatura;
