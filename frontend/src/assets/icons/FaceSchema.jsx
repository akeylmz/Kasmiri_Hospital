...
const FaceSchema = () => {
    ...
    const [face, setFace] = useState([
        { "id": "forehead", "selected": false },
        { "id": "right-temple", "selected": false },
        { "id": "left-temple", "selected": false },
        { "id": "nose", "selected": false },
        { "id": "right-ear", "selected": false },
        { "id": "left-ear", "selected": false },
        { "id": "upper-lip", "selected": false },
        { "id": "lower-lip", "selected": false },
        { "id": "right-cheek", "selected": false },
        { "id": "left-cheek", "selected": false },
        { "id": "chin", "selected": false },
        { "id": "neck", "selected": false },
        { "id": "right-under-eye", "selected": false },
        { "id": "left-under-eye", "selected": false },
        { "id": "right-eyebrow", "selected": false },
        { "id": "left-eyebrow", "selected": false },
      ])

  return (
    <svg width="450" height="565" viewBox="0 0 740 925" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <path 
            ...
            onClick={() => {
                ...
                updatedFace[11].selected = !updatedFace[11].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[11].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[14].selected = !updatedFace[14].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[14].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[15].selected = !updatedFace[15].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[15].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[6].selected = !updatedFace[6].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[6].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[7].selected = !updatedFace[7].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[7].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[3].selected = !updatedFace[3].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[3].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[4].selected = !updatedFace[4].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[4].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
            />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[5].selected = !updatedFace[5].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[5].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[13].selected = !updatedFace[13].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[13].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[12].selected = !updatedFace[12].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[12].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[0].selected = !updatedFace[0].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[0].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[1].selected = !updatedFace[1].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[1].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[2].selected = !updatedFace[2].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[2].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[10].selected = !updatedFace[10].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[10].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[8].selected = !updatedFace[8].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[8].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
        <path 
            ...
            onClick={() => {
                const updatedFace = [...face]
                updatedFace[9].selected = !updatedFace[9].selected
                setFace(updatedFace)            
            }}
            style={{fill: face[9].selected ? "#06b5d45b" : "transparent", stroke: "black"}}
        />
    </svg>
