    ...
    <div className="add-modal z-50 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 ">
      <div className="bg-lightGray rounded-lg shadow-lg w-full max-w-4xl p-8">
        ...
        <div>
            ...
            <select  className="mt-1 block w-full border border-gray-200 rounded-md shadow-sm focus:ring-cyan-500 focus:border-cyan-500 sm:text-sm px-3 py-2">
                <option value="">Sağlık Turizm Hastası</option>
                <option value="">Turistin Sağlığı</option>
            </select>
          </div>
          <div>
